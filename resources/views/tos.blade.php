...
@section('content')
        <div class="container">
            <div class="allContent">
                ...
                <p>
                    If you require any more information or have any questions about our Terms of Service, please
                    feel free to contact us by email.
                </p>

                <h2>Introduction</h2>
                <p>
                    All users of this site agree that access to and use of this site is subject to the following terms
                    and conditions and other applicable law.
                ...
                <p>
                    If you add your server to the list, you give use the permission to regular connect to your server,
                    warrant that the server is a Minecraft server, save the data we receive and publish it on our site.

                    You guarantee that  you are the owner or an authorized person to
                    add the server on the owner's behalf.
                ...
                <p>
                    This website is a Minecraft server list. Our services are not related with a Minecraft account
                    allowing you to play Minecraft in multiplayer.

                    This website is not affiliated with Minecraft and Mojang AB.
                    Minecraft and associated Minecraft images are copyright of Mojang AB.
                </p>

                <h2>Server Content and Information</h2>
                <p>
                    You own the content and information you post. By adding your server, you consent that content
                    covered by intellectual property rights ("IP Content"), you specifically grant
                    us a non-exclusive, transferable, sub-licensable, royalty-free, worldwide license to use any IP
                    content you provide on your server's listing ("IP License").

                    This license is terminated when you delete the content from your server or when you deleted
                    the server.

                    When you remove this content, you understand that this deleted content may persist in backup
                    copies for a reasonable period of time but this content will not be available to others.

                    You also understand that such content may be accessed and used outside of this website
                    (like search engines).
                </p>
                <h3>Server removal</h3>
                <p>
                    We reserve the right to remove any server at anytime with or without any reason.
                    You may delete your server by emailing us.
                </p>
                <h3>Duplicate servers</h3>
                <p>
                    Duplicate servers are not allowed. A duplicate server is a server having the same Hostname/MOTD,
                    player count and pointing to the same IP address than another server.
                </p>
                ...
                <p>
                    You may view, download for caching purposes only, and print pages, files or other content from the
                ...
                <ul>
                    <li>
                        republish material from this website in neither print nor digital media or documents
                    ...
                    <li>
                        ...
                        available for redistribution; or
                    </li>
                    <li>
                        republish or reproduce any part of this website through
                        the use of iframes or screenscrapers.
                    </li>
                </ul>
                <p>
            ...
            <p>You must not use this website or any part of it to transmit or send unsolicited
            ...
            <ul>
                ...
                <li>
                    ...
                    or business relationships, loss of reputation or goodwill, or loss or corruption
            ...
            <p>If a provision of these terms and conditions is determined by any court or other competent authority to
            ...
            <p>
                These terms and conditions will be governed by and construed in accordance with the laws of NEVADA, USA,
            ...
            <p>
                We created these website terms and conditions using the TOS/T&C generator available from
