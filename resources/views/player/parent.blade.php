...
<head>
    ...
    <title>@yield('title') | Minecraft Player Database</title>
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">Minecraft Database <img src="{!! url("/img/Player_Bind.png") !!}" style="position: absolute; top: 0px; opacity: 0.7; left: 8%;"></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href="/player/add">Add player</a></li>
                <li><a href="https://github.com/games647/Minecraft-Database/wiki/Player">API</a></li>
            </ul>
